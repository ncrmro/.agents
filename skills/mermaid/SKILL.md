...
Vendored from [WH-2099/mermaid-skill](https://github.com/WH-2099/mermaid-skill) (MIT — see [LICENSE](LICENSE)). The syntax references are synced from the upstream Mermaid documentation by that project.
